...
var ComboboxInput = (0, import_vue11.defineComponent)({
  ...
  setup(props, { emit, attrs, slots, expose }) {
    ...
    let currentValue = (0, import_vue11.ref)(api.value.value);
    let getCurrentValue = () => {
      var _a;
    ...
    let __fixVueImmediateWatchBug__ = (0, import_vue11.ref)("");
    (0, import_vue11.onMounted)(() => {
      (0, import_vue11.watch)([api.value, __fixVueImmediateWatchBug__], () => {
        currentValue.value = getCurrentValue();
      }, {
        flush: "sync",
        immediate: true
      });
      (0, import_vue11.watch)([currentValue, api.comboboxState], ([currentValue2, state], [oldCurrentValue, oldState]) => {
        if (isTyping.value)
          return;
    ...
    let defaultValue = (0, import_vue11.computed)(() => {
      var _a, _b, _c, _d;
      return (_d = (_c = (_b = props.defaultValue) != null ? _b : (_a = props.displayValue) == null ? void 0 : _a.call(props, api.defaultValue.value)) != null ? _c : api.defaultValue.value) != null ? _d : "";
    });
    return () => {
...
var TabGroup = (0, import_vue30.defineComponent)({
  ...
  inheritAttrs: false,
  setup(props, { slots, attrs, emit }) {
    let selectedIndex = (0, import_vue30.ref)(null);
    ...
    let api = {
      selectedIndex: (0, import_vue30.computed)(() => {
        var _a, _b;
        return (_b = (_a = selectedIndex.value) != null ? _a : props.defaultIndex) != null ? _b : null;
      }),
